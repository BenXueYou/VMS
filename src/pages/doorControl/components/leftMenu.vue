<template>
	<el-row ref="headerH" class="header left_menu">
		<el-row class="el-row">
			<el-col :span="24">
				<el-menu
                ...
                src="../../../assets/images/doorAccess/access_auth_select.png"
						...
						<el-menu-item index="/DoorControl/AccessCaseConfig">特殊日期</el-menu-item>
					</el-submenu>
                ...
                src="../../../assets/images/doorAccess/access_set_select.png"
						...
						<el-menu-item index="/DoorControl/AntiBack">反潜回</el-menu-item>
						<el-menu-item index="/DoorControl/FirstCardOpen">首卡开门</el-menu-item>
						<el-menu-item index="/DoorControl/ManMakeUpOpen">多人组合开门</el-menu-item>
						<el-menu-item index="/DoorControl/WayMakeUpOpen">多验证方式开门</el-menu-item>
