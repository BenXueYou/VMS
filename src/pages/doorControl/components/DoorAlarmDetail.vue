<template>
  <el-dialog class="AlarmDetail"
    ...
    <div class="alarmBox">
      <div class="topBox">
        <img src="@/assets/images/temperature/temperature_alarm_icon.png"
             alt
             srcset />报警图片
      </div>
      <div class="tipsBox">
        <div class="leftImageBox">
          <el-image :src="defaultDetail.extInfo?$common.setPictureShow(defaultDetail.extInfo.snapPhotoUrl,'facelog'):$common.setPictureShow(defaultDetail.extInfo)"></el-image>
        </div>
        <div class="rightTxtBox">
          ...
          <p>
            报警等级：
            <span style="color: #FF5F5F;">{{defaultDetail.alarmLevel?$common.getEnumItemName("alarm_l", defaultDetail.alarmLevel):'紧急'}}</span>
          </p>
        </div>
      </div>
    </div>
    <div class="staffBox"
      ...
      <div class="topBox">
        <img src="@/assets/images/temperature/temperature_staff_icon.png"
             alt
             srcset />人员信息
      </div>
      <div class="tipsBox">
        <div class="leftImageBox">
          <el-image :src="defaultDetail.extInfo?$common.setPictureShow(defaultDetail.extInfo.certificatePhotoUri):$common.setPictureShow(defaultDetail.extInfo)"></el-image>
        </div>
        <div class="rightTxtBox">
          <p>
            姓名：
          ...
          <p>
            人员类型：
            <span>{{defaultDetail.extInfo && defaultDetail.extInfo.staffType?$common.getEnumItemName('staff_t',defaultDetail.extInfo.staffType[0]):''}}</span>
          </p>
        </div>
      </div>
    </div>
    <div class="detalBox">
      <div class="topBox">
        <div>
          <img src="@/assets/images/temperature/temperature_deteal_icon.png"
               alt
               srcset />警情处理
        </div>
