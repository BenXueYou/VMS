<template>
  <div class="access-main">
    ...
    <div class="face-table">
      <el-scrollbar style="height: 92%;transition:0.2s">
        <el-table :data="tableData"
          ...
          <el-table-column v-if="$store.state.home.projectType.platformType !== 'school'"
                           prop="address"
                           label="地址"
          ...
          <el-table-column prop="valided"
                           label="报警有效性"
                           show-overflow-tooltip>
            <template slot-scope="scope">{{scope.row.valided === 0 ? "误报" : "有效"}}</template>
          </el-table-column>
    ...
    <door-alarm-detail :visible.sync="isDoorAlarmDetailVisible"
                       ...
                       @close="initData"></door-alarm-detail>
  </div>
</template>
<script>
