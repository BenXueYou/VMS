	...
	<div class="wrap adasjdka">
		<div class="left">
			<div class="button_group">
				...
				>新增</el-button>
				<el-button :disabled="!OwnAuthDisabled" type="primary" @click="xiafaAll" size="small">全部下发</el-button>
			</div>
			...
			>
				...
				<el-table-column prop="peopleCount" width="100" label="人员数量"></el-table-column>
			</el-table>
		</div>
		<div class="right" v-show="!powerDialogVisible">
			<div class="button_group">
				...
				<el-button
					...
					icon="el-icon-edit-outline"
				>编辑</el-button>
				<el-button :disabled="!OwnAuthDisabled" type="primary" @click="xiafa" size="small">下发权限</el-button>
			</div>
				...
				<div class="cccc">
					...
					<div class="aaaa">
						<div v-for="(item,index) in date" :key="index">
							...
							<span class="area" v-for="(v,i) in item.content" :key="i">开始时间：{{v.begin}} ~ 结束时间：{{v.end}}</span>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="mydoor">
					...
					<div class="doorWrap" :style="{'max-height':MH2}">
						<el-popover
							...
							class="message"
						>
							<div v-if="item.resType=='staff' || item.resType=='resident'" class="hoverPerson">
								<div class="head">
                  ...
                  <div class="name">
                    {{item.staffName}}
							...
							<gt-button
								:icon="(item.resType=='staff'||item.resType=='resident')?icons.personHead:icons.folder"
								slot="reference"
								:show-close="false"
