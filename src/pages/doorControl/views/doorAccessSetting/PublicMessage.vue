...
export default {
  ...
  methods: {
    ...
    handleRowClick(row) {
      ...
      this.$DoorSetAjax
        .getPublicMessageApi(row.noticeUuid)
        .then(res => {
    ...
    getPublicMessageApiSuccessResponse(body) {
      ...
      if (!body.resourceSetVOS) {
        ...
        this.resourceSet = this.$common.copyArray(body.resourceSetVOS, this.resourceSet);
      }
    ...
    httpRequest(e) {
      if (e.file.type === "image/png" || e.file.type === "image/jpg" || e.file.type === "image/jpeg") {
