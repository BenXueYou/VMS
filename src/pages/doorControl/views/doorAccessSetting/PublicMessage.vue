	...
	<el-row class="PublicMessage" ref="mainWMHeight" type="flex" style="height: 100%">
		<el-col class="PMBox PBoxMenu" :span="4" style="height: 100%">
			...
			<el-table
				...
				v-loading="isLoading"
			>
				<el-table-column prop="noticeName" label="公告"></el-table-column>
				<el-table-column label="操作" width>
					<template slot-scope="scope">
						<el-button
							...
							size="small"
							class="delete-button"
							@click.stop="deleteNotice(scope.row)"
						>删除</el-button>
					</template>
				</el-table-column>
			</el-table>
		</el-col>
		<el-col class="PMBox PBoxMain" :span="20">
			<el-scrollbar style="height: 98%;transition:0.2s">
				<el-row type="flex" justify="center" :gutter="30">
					<el-col class="left_box" :span="5">
						<p>
					...
					<el-col class="right_box" :span="19">
						...
						<el-header>
							<span class="left_tips_txt">
								<el-checkbox @change="onChangeLoop" v-model="loop">循环播放</el-checkbox>
							</span>
							<span class="tips_txt" v-if="picture.length > 1">
								每张停留时间
								<el-input type="number" v-model="duration"></el-input>秒
							</span>
						</el-header>
						<el-row class="colRowBoxClass" style="margin-top: 15px;">
							<el-row
								:gutter="13"
								id="scrollView"
								class="colBoxClass"
							...
							>
								<el-col class :span="4" v-for="(item, index) in pictureForLocalShow" :key="index">
									<div class="imgListCellClass">
										<img width="140px" height="120px" :src="showPicture(item)" />
										<div class="imgBox" @click="deleteImage(index)">
				...
				<el-row type="flex" justify="center" style="margin-top: 20px;" :gutter="30">
					<el-col class="left_box" :span="5">
						<p>信息：</p>
					</el-col>
					<el-col class="i-inner" style="margin-top: 10px;" :span="19">
						<el-input type="textarea" :rows="4" maxlength="180" placeholder="最多可输入180个字符" v-model="info"></el-input>
					</el-col>
				</el-row>
				<el-row type="flex" justify="center" :gutter="30">
