	...
	<div class="Interlocking">
		<el-row ref="headerRef" class="header" type="flex" justify="space-between">
			...
			<el-col :span="4" class="header-buttton-box">
				<el-button :disabled="!OwnAuthDisabled" type="primary" @click="addInterLockingAct">
		...
		<el-row ref="bodyRef" class="body">
			<el-table :data="tableData" style="width: 100%">
				...
				<el-table-column prop="groupName" label="互锁组名称" width="180"></el-table-column>
				...
				<el-table-column label="操作" width="200">
					<template slot-scope="scope">
						<el-button type="text" size="small" @click.stop="editButtonAct(scope.row)">编辑</el-button>
						<el-button
		...
		<!-- --------------------------    弹窗   ------------------------------------- -->
		<interlocking-dialog :isShow="isShow" :row="row" @onCancel="addInterLockingAct"></interlocking-dialog>
	</div>
</template>
<script>
