  ...
  <div class="ManMakeUpOpen">
    ...
    <el-row ref="bodyRef"
      ...
      <el-table :data="tableData"
        ...
        <el-table-column prop="atLeast"
                         label="至少验证通过人数"
                         width="150"></el-table-column>
        <el-table-column prop="intervals"
                         label="验证时间间隔（秒）"
                         width="150"></el-table-column>
    ...
    <!-- --------------------------    弹窗   ------------------------------------- -->
    <ManMakeUpOpen-dialog :row="row"
                          :isShow="isShow"
                          @onCancel="addManMakeUpOpenAct"></ManMakeUpOpen-dialog>
  </div>
</template>
<script>
