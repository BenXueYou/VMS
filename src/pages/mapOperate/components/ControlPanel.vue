<template>
  <div class='controlPanel'>
    <div class="head">
      <ul>
        <li @click='setTimeDialog'
            style="color:#fff;white-space:nowrap;line-height:9px;">
          设置播放时间
        </li>
...
import timeline from "@/pages/VideoPlayback/components/timeline";
import timeSelect from "@/pages/VideoPlayback/components/timeSelect";
export default {
  name: "ControlPanel",
  components: {
    timeline,
