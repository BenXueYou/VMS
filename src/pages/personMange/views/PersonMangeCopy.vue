<template>
  <div class="personMange"
       id="personMange">
    <the-leftmenu :ShowAuthDisabled='ShowAuthDisabled'
              ...
              <div class="requireInfo">
                ...
                <div class="infoWrap"
                  ...
                  <div class="right apartment">
                    ...
                    <div class="edit">
                      <img src="./../../../assets/images/personMange/edit.png" />
                      <span v-show="addEditMember==='edit'" @click="getMsgToDeviceDialogVisiable5=!getMsgToDeviceDialogVisiable5">修改</span>
                      <span v-show="addEditMember==='add'" @click="getMsgToDeviceDialogVisiable5=!getMsgToDeviceDialogVisiable5">新增</span>
                    </div>
                  </div>
                </div>
                <div class="infoWrap">
                ...
                <div class="infoWrap"
                  ...
                  <div class="right apartment">
                    ...
                    <div class="edit">
                      <img src="./../../../assets/images/personMange/edit.png" />
                      <span v-show="addEditMember==='edit'" @click="addMsgToDeviceDialogVisiable=!addMsgToDeviceDialogVisiable">修改</span>
                      <span v-show="addEditMember==='add'" @click="addMsgToDeviceDialogVisiable=!addMsgToDeviceDialogVisiable">新增</span>
                    </div>
                  </div>
                  <div class="more"
                       v-show="isAdditional"
    ...
    <!--删除弹窗-->
    <el-dialog class="deleteDialog dialogPosition"
    ...
    <!--Excel批量导出人员-->
    <el-dialog class="exportDialog dialogPosition"
               :title="'Excel批量导出人员'"
    ...
    <!--数据统计弹窗-->
    <el-dialog class="StaticsViewDialogClass dialogPosition"
               width="550px"
               :title="chartTitle"
    ...
    <!--新增卡片弹窗-->
    <el-dialog class="addCardDialog dialogPosition"
               :title="'新增卡片'"
...
.personMange .dialogPosition {
  display: flex;
  flex-direction: row;
  justify-content: center;
  align-items: center;
}
.personMange .dialogPosition .dialog-footer {
  margin-top: 20px;
}
