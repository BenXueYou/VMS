<template>
  <div class="personMange"
    ...
    <div class="rightmenu"
      ...
      <div v-show="isOrganiza">
          ...
          <div class="head">
            ...
            <div class="carte">
              <div @click="changeLeftMenu('1')"
                   style="cursor:pointer;"><img src="./../../../assets/images/personMange/edit.png" /><span>修改名称</span></div>
              <div @click="changeLeftMenu('2')"
                   style="cursor:pointer;"><img src="./../../../assets/images/personMange/add.png" /><span>添加子部门</span></div>
              <div @click="setApartmentLeader"
                   style="cursor:pointer;"><img src="./../../../assets/images/personMange/set.png" /><span>设置上级</span></div>
            </div>
          </div>
          <div class="listWrap">
            <div class="bthWrap">
              ...
              <div class="right">
                ...
                <el-button style="width: 80px;"
                           class="search"
                           @click="isOtherSearch=false,clearSearchInfo(),clickNodeList()"><img src="./../../../assets/images/personMange/search.png" />检索</el-button>
                    ...
                    <div class="infoWrap">
                      ...
                      <div class="right">
                        <el-date-picker v-model="searchStartTime"
                                        ...
                                        placeholder="选择日期"
                                        style="width: 120px;">
                        </el-date-picker><span style="margin: 0 6px; color: rgba(255,255,255,0.15);">-</span>
                ...
                <el-button style="width: 100px;"
                           class="switch"
                           @click="isTableStyle=false,getImageList()"><img src="./../../../assets/images/personMange/switch.png" />切换视图</el-button>
              </div>
            </div>
            <div class="tableWrap">
                ...
                <el-table-column prop="netStatus"
                  ...
                  <template slot-scope="scope">
                    <div style="display: flex;flex-direction: row;align-items: center;justify-content: center;">
                      ...
                      <span style="margin: 0 15px 0 7px;display: flex;flex-direction: row;align-items: center;"><img v-if="true"
                             src="./../../../assets/images/personMange/fingerprint.png"
                             style="margin:0 10.2px 0 13px;" />{{scope.row.voucher.fingerprintNum}}</span>
                      <span style="display: flex;flex-direction: row;align-items: center;"><img v-if="true"
                             src="./../../../assets/images/personMange/card.png"
                             style="margin-right: 11.5px" />{{scope.row.voucher.cardNum}}</span>
                    </div>
                  </template>
                </el-table-column>
                  ...
                  <template slot-scope="scope">
                    <div style="display: flex;flex-direction: row;align-items: center;justify-content: center;">
                      <span style="cursor:pointer;font-family: PingFangSC-Regular;font-size: 13px;color: #26D39D;display: flex;flex-direction: row;align-items: center;"
                            @click="viewSingleDetail(scope.row)"><img src="./../../../assets/images/personMange/detail.png"
                             style="margin-right: 5.9px" />详情</span>
        ...
        <div class="imageForm"
          ...
          <div class="head">
            <div class="title">{{viewGroupName}}&nbsp;&nbsp;({{totalStaff}})</div>
            <div class="carte">
              <div @click="changeLeftMenu('1')"><img src="./../../../assets/images/personMange/edit.png" /><span>修改名称</span></div>
              <div @click="changeLeftMenu('2')"><img src="./../../../assets/images/personMange/add.png" /><span>添加子部门</span></div>
              <div @click="setApartmentLeader"><img src="./../../../assets/images/personMange/set.png" /><span>设置上级</span></div>
            </div>
          </div>
          <div class="listWrap">
            <div class="bthWrap">
              ...
              <div class="right">
                <div class="otherSearch"
                     @click.stop="isOtherSearch=true">
                  <el-button style="width: 100px;"
                             class="search"><img src="./../../../assets/images/personMange/search.png"
                         @click.stop="isOtherSearch=!isOtherSearch" />人员检索</el-button>
                  <div class="conditionWrap"
                       v-show="isOtherSearch">
                    <div class="infoWrap">
                      <div class="left">性别：</div>
                ...
                <el-button style="width: 100px;"
                           class="switch"
                           @click="isTableStyle=true,getFormList()"><img src="./../../../assets/images/personMange/switch.png" />切换视图</el-button>
              </div>
            </div>
            <div class="tableWrap">
              ...
              <div class="inforWrap">
                <div class="singleCell"
                  ...
                  <img :src="tableData.length>index?(tableData[tableData.length-index-1].photoUri?WIamgeurl + tableData[tableData.length-index-1].photoUri:require('@/assets/images/user.png')):require('@/assets/images/user.png')"
                       class="mainImg"
                       id="mainImg" />
                  <div style="height: 16px">{{tableData.length>index?tableData[tableData.length-index-1].staffName:"姓名"}} <span v-if="tableData.length>index"><span v-if="tableData[tableData.length-index-1].gender=='male'">男</span><span v-if="tableData[tableData.length-index-1].gender=='female'">女</span></span><span v-if="tableData.length<=index">性别</span> {{tableData.length>index?tableData[tableData.length-index-1].orgName:"部门"}}</div>
                  ...
                  <div class="operationMask"
                    ...
                    <div @click.stop="isOperationMask=false,viewSingleDetail(tableData[tableData.length-index-1])"><img src="./../../../assets/images/personMange/detail1.png" /><span>详情</span></div>
                    <div @click.stop="isOperationMask=false,editPersonSingle(tableData[tableData.length-index-1])"><img src="./../../../assets/images/personMange/edit.png" /><span>编辑</span></div>
                    <div @click.stop="isOperationMask=false,deletePersonSingle(tableData[tableData.length-index-1])"><img src="./../../../assets/images/personMange/delete1.png" /><span>删除</span></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <el-scrollbar style="width: 64%;height: 100%">
            <div style="width: 100%;background: #212325;padding: 0 44px;box-sizing: border-box;overflow: hidden;">
              <div class="title">
                <div class="text">
                  <span></span>
                  <span v-show="addEditMember==='add'">添加成员</span><span v-show="addEditMember==='edit'">编辑员工</span>
                </div>
                <div class="btnWrap">
                  ...
                  <div class="right1">
                    <div>
                      <el-input style="width: 120px;height: 32px;margin-right: 10px;"
                                placeholder="姓名"
                                v-model="staffName"></el-input><span>*</span>
                    </div>
                    <div>
                ...
                <div class="infoWrap"
                  ...
                  <div class="right">
                    <el-date-picker v-model="startTime"
                                    ...
                                    placeholder="选择日期"
                                    style="width: 160px;">
                    </el-date-picker><span style="margin: 0 6px;">-</span>
              ...
              <div class="accessCon1 accessAdd"
                ...
                <div class="infoWrap">
                  ...
                  <div class="right">
                    <div @click="addCards">
                      <img src="./../../../assets/images/personMange/addCard.png" />
                      <span>新增卡片&nbsp;&nbsp;<span class="addWrap">|</span>&nbsp;&nbsp;发卡器配置</span>
                    </div>
                  </div>
                </div>
                <div class="cardInfo">
                ...
                <div class="infoWrap">
                  ...
                  <div class="right">
                    <img src="./../../../assets/images/personMange/addCard.png" />&nbsp;<span>新增指纹</span>
                  </div>
                </div>
              </div>
      ...
      <div class="labelForm"
        ...
        <div class="head">
          ...
          <div class="carte">
            <div @click="changeLeftMenu('1')"><img src="./../../../assets/images/personMange/edit.png" /><span>修改名称</span></div>
            <div @click="viewLabelDetail"><img src="./../../../assets/images/personMange/labelDetail.png" /><span>标签详情</span></div>
          </div>
        </div>
        <div class="listWrap">
          <div class="bthWrap">
    ...
    <el-dialog class='detailDialog'
      ...
      <div class="detailWrap">
        <div class="linkInfo"
          ...
          <div class="leftImage"><img :src="viewFontPhoto? viewFontPhoto : require('@/assets/images/user.png')" /></div>
        </div>
        <div class="linkInfo">
          <div class="inforWrap">
            <div class="left">手机：</div>
        ...
        <div class="jobInfo">
          <div class="inforWrap">
            <div class="left">部门：</div>
            <div class="right"><span v-for="(item,index) in viewOrgUuid"
                    :key="index"
                    style="margin-right: 5px;">{{item.orgName}}</span></div>
          </div>
          <div class="inforWrap">
            <div class="left">标签：</div>
            <div class="right"><span v-for="(item,index) in viewTagUuids"
                    :key="index"
                    style="margin-right: 5px;"><img class="img1"
                     src="./../../../assets/images/personMange/equipment.png" />{{item.tagName}}</span></div>
          </div>
          <div class="inforWrap">
            <div class="left">职务：</div>
          ...
          <div class="inforWrap">
            <div class="left">负责部门：</div>
            <div class="right"><span style="margin-right: 5px;"
                    v-for="(item,index) in viewApartment"
                    :key="index">{{item.orgName}}</span></div>
          </div>
        </div>
        <div class="accessInfo">
          <div class="inforWrap">
            <div class="left">卡：</div>
            <div class="right"><span class="sp1"
                    v-for="(item,index) in viewCardList"
                    :key="index"><img class="img1"
                     src="./../../../assets/images/personMange/card.png" />{{item.cardId}}</span></div>
          </div>
          <div class="inforWrap">
            <div class="left">指纹：</div>
            <div class="right"><span class="sp1"><img class="img1"
                     src="./../../../assets/images/personMange/fingerprint1.png" /></span></div>
          </div>
          <div class="inforWrap colm1Wrap"
               id="trafficAuthList">
            <div class="left">通行权限组：</div>
            <div class="right colm1"><span v-for="(item,index) in viewTrafficAuthList"
                    :key="index">{{item.groupName}}</span></div>
          </div>
          <div class="inforWrap colm1Wrap">
            <div class="left">访客权限组：</div>
            <div class="right colm1"><span v-for="(item,index) in viewVisitorAuthList"
                    :key="index">{{item.groupName}}</span></div>
          </div>
          <div class="inforWrap"
          ...
          <div class="inforWrap">
            <div class="left">有效期：</div>
            <div class="right"><span v-if="viewTimeRange">长期有效</span><span v-if="!viewTimeRange">{{this.viewBeginTime}} - {{this.viewEndTime}}</span></div>
          </div>
        </div>
    ...
    <el-dialog class='deleteDialog'
               ...
               width="400px">
      <div class="con">
        <div class="title"><img src="./../../../assets/images/personMange/delete2.png" /><span> 是否确定删除选中员工？</span></div>
        <div class="btnWrap">
    ...
    <el-dialog class='labelDetailDialog'
      ...
      <div class="con">
        <div class="detail1">
          <div class="left"><img src="./../../../assets/images/personMange/label.png" /><span>{{labelName}}：</span></div>
    ...
    <el-dialog class='exportDialog'
      ...
      <div class="con">
        <div class="save">
          ...
          <div><img src="./../../../assets/images/personMange/path.png" /><span class="sp1">选择地址</span></div>
        </div>
        <div class="text">
...
export default {
  ...
  methods: {
    ...
    shootAct() {
      ...
      this.frontUploaded = true;
      this.frontPhoto = canvas.toDataURL("image/png");
