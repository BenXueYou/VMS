  ...
  <div class="login-div">
    ...
    <div class="login-foot">
      ...
      <div style="margin:0px auto;font-size:14px;text-algin:center;padding:20px 0 10px">
        <p style="height:0px;line-height:20px;margin: 0px 0px 0px 5px; color:#939393;text-algin:center">2019© 上海广拓 沪ICP备09001829号-3</p>
      </div>
      <div style="margin:0 auto; padding:20px 0;">
        <a target="_blank"
          ...
          <p style="height:0px;line-height:20px;margin: 0px 0px 0px 5px; color:#939393; font-size:14px">沪公网安备 31010602003853号</p>
        </a>
      </div>
    </div>
  </div>
