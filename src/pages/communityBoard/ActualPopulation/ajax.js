...
// 获取门禁感知离开，图4
export function getMapChart4(data) {
  let url = `${protocolHeader}${ip}${RestApi.api.peopleMange.residentPerception(data.data2)}`;
  let parms11 = data.data1;
  console.log("parms11===", parms11);
  return axios({
    method: "get",
    url,
    params: data.data1
...
export function getMapChart1(data) {
  let url = `${protocolHeader}${ip}${RestApi.api.peopleMange.getMapChart(data)}`;
  return axios({
    method: "get",
    url,
    params: data
...
export function getMapChart2(data) {
  let url = `${protocolHeader}${ip}${RestApi.api.peopleMange.populationType(data)}`;
  return axios({
    method: "get",
    url,
    params: data
...
export function getMapChart3(data) {
  let url = `${protocolHeader}${ip}${RestApi.api.peopleMange.populationTotal(data)}`;
  return axios({
    method: "get",
    url,
    params: data
...
export function getPeopleList(parms) {
  ...
  let url = `${protocolHeader}${ip}${RestApi.api.peopleMange.residentList(parms.data2)}`;
  return axios({
    method: "get",
    url,
    params
...
export function getPeopleStatistics(parms) {
  ...
  console.log("parms1111===", parms.dada);
  console.log("parms2222===", parms.id);
  let url = `${protocolHeader}${ip}${RestApi.api.peopleMange.residentStatistics(parms.data2)}`;
  return axios({
    method: "get",
    url,
    data
