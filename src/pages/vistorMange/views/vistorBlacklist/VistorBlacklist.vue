<template>
	<div class="Backlist" v-loading="showLoading">
		<div class="header">
			<div>黑名单列表</div>
		</div>
		<div class="main">
			...
			>
				...
				<el-table-column prop="blacklistName" label="姓名"></el-table-column>
				...
				<el-table-column prop="blockDatetime" label="拉黑时间" sortable="custom"></el-table-column>
				<el-table-column prop="source" label="黑名单来源">
				...
				<el-table-column label="操作" min-width="100">
					<template slot-scope="scope">
						<div class="tableCertificateBtnClass">
							<el-button type="text" @click="editBtnAct(scope.row)" :disabled="!OwnAuthDisabled">编辑</el-button>
							<el-button type="text" @click="detailBtnAct(scope.row)" :disabled="!ShowAuthDisabled">详情</el-button>
							<el-button
								type="text"
					...
					<div class="cellBox" v-for="(item,index) in tableCellData" :key="index">
						...
						>
							<el-row class="popoverBox" justify="space-between">
								...
								>
									<img v-if="!ShowAuthDisabled" class="img" src="@/assets/images/personMange/detail1.png" />
									<img v-else class="img" src="@/assets/images/personMange/detail.png" />
									详情
								</el-col>
								<el-col
								...
								>
									<img v-if="OwnAuthDisabled" class="img" src="@/assets/images/personMange/edit.png" />
									<img v-else class="img" src="@/assets/images/personMange/edit2.png" />
									编辑
								</el-col>
								<el-col
									:class="OwnAuthDisabled?'cursorClass':''"
								...
								>
									...
									/>
									<img v-else class="img" src="@/assets/images/personMange/delete2.png" />
									移除
								</el-col>
							</el-row>
							<el-row slot="reference" class="cellItemClass">
								...
								<div class="txtBox">
									...
									<span
										...
										@mouseout="mymouseout"
										@mousemove="mymousemove"
									>{{item.credentialNo}}</span>
									<span
										class="textClips"
										@mouseover="mymouseover"
										@mouseout="mymouseout"
										@mousemove="mymousemove"
									>{{$common.getEnumItemName("blacklistSource", item.source)}}</span>
								</div>
			...
			<blacklist-add
				...
				:title="title"
				:defaultRow="defaultRow"
				@closeAddDialogDetail="closeAddDialogDetail"
			></blacklist-add>
			<!----------------------------------表格分页器---------------------------------->
			<div class="footer">
				<el-pagination
