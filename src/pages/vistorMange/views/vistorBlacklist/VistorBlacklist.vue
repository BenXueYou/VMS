<template>
	<div class="Backlist" v-loading="showLoading">
		...
		<div class="main">
					...
					<div class="cellBox" v-for="(item,index) in tableCellData" :key="index">
						...
						>
							<el-row class="popoverBox" justify="space-between">
								...
								<el-col class="BLelPopoverCol cursorClass" @click.native="editResident(item)">
			...
			<blacklist-detail :visible="isShow" :defaultRow="defaultRow" @close="closeDetail"></blacklist-detail>
			<blacklist-add
