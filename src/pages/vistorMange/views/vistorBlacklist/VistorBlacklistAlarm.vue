<template>
	<div class="BlacklistAlarm" v-loading="showloading">
		<div class="header">
			<div>黑名单报警记录</div>
		</div>
		<div class="main">
			...
			>
				...
				<el-table-column prop="resName" label="姓名"></el-table-column>
				...
				<el-table-column prop="resType" label="报警原因" :show-overflow-tooltip="true">
					<template slot-scope="scope">
				...
				<el-table-column prop="address" label="报警地点" show-overflow-tooltip>
					<template
						slot-scope="scope"
					>{{scope.row.extInfo&&scope.row.extInfo.deviceName?scope.row.extInfo.deviceName:''}}</template>
				</el-table-column>
				<el-table-column prop="alarmTime" label="报警时间"></el-table-column>
				<el-table-column prop="dealState" label="处理状态">
					<template slot-scope="scope">
						<div>{{$common.getEnumItemName("alarm_r",scope.row.dealState)}}</div>
					</template>
				</el-table-column>
				<el-table-column prop="valided" label="报警有效性">
					<template slot-scope="scope">
			...
			<blacklist-alarm-detail :visible="isShow" :defaultAlarmDetail="rowData" @close="closeDetail"></blacklist-alarm-detail>
