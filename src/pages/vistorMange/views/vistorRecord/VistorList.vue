  ...
  <div class="VistorList"
    ...
    <div class="main">
      <div class="main-header">
        <div>
          <el-button :disabled="!$common.getAuthIsOwn('访客列表','isShow')"
                     type="primary"
                     size="mini">数据统计</el-button>
          <el-button :disabled="!$common.getAuthIsOwn('访客列表','isOwn')"
                     type="primary"
      ...
      <el-table v-if="!tableOrTableCell"
        ...
        <el-table-column prop="company"
                         label="访客单位"></el-table-column>
        <el-table-column prop="firstRegDatetime"
                         label="首次登记时间"
                         show-overflow-tooltip
                         sortable="custom"></el-table-column>
        <el-table-column prop="lastRegDatetime"
                         label="最近登记时间"
                         show-overflow-tooltip
                         sortable="custom"></el-table-column>
              ...
              <el-row slot="reference"
                ...
                <div class="txtBox">
                  ...
                  <div class="textClips"
                       @mouseover="mymouseover"
                       @mouseout="mymouseout"
                       @mousemove="mymousemove">{{item.company || '访客单位'}}</div>
                </div>
      ...
      <vistor-detail :visible="isShow"
                     :OwnAuth="$common.getAuthIsOwn('访客列表', 'isOwn')"
                     :vistorDetail="vistorDetail"
                     @close="closeDetail"></vistor-detail>
      <!----------------------------------表格分页器---------------------------------->
      <div class="footer">
