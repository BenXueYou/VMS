<template>
	<div class="VistorRecord" v-loading="showloading">
		<div class="header">
			<div>访客记录</div>
		</div>
		<div class="main">
			...
			>
				...
				<el-table-column prop="visitorName" label="姓名" width="100"></el-table-column>
				...
				<el-table-column prop="plateNo" label="车牌号码" :show-overflow-tooltip="true"></el-table-column>
				<el-table-column prop="regDeviceNickName" show-overflow-tooltip label="登记设备"></el-table-column>
				<el-table-column prop="source" label="登记途径">
					<template
						slot-scope="scope"
					>{{$common.getEnumItemName("visitor_singon_ways", scope.row.source)}}</template>
				</el-table-column>
				<el-table-column prop="regDatetime" label="登记时间" show-overflow-tooltip></el-table-column>
				<el-table-column prop="staffName" label="被访人员"></el-table-column>
				<el-table-column prop="reason" label="来访事由"></el-table-column>
				<el-table-column prop="visitState" label="访客状态">
					<template
						slot-scope="scope"
