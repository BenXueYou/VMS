<template>
	<div class="AppointInviteRecord" v-loading="showloading">
		<div class="header">
			<div>预约/邀请记录</div>
		</div>
		<div class="main">
			...
			>
				...
				<el-table-column prop="reservationDatetime" show-overflow-tooltip label="预约/邀请时间"></el-table-column>
				<el-table-column prop="visitorName" label="访客姓名" width="90"></el-table-column>
				<el-table-column prop="phoneNo" label="访客手机"></el-table-column>
				<el-table-column prop="plateNo" label="访客车牌" :show-overflow-tooltip="true"></el-table-column>
				<el-table-column prop="staffName" label="被访人姓名"></el-table-column>
				<el-table-column prop="staffPhoneNo" label="被访人手机"></el-table-column>
				<el-table-column
					prop="estimatedDatetimeArrive"
					label="预计到达时间"
					show-overflow-tooltip
					sortable="custom"
				></el-table-column>
				<el-table-column
					prop="estimatedDatetimeLeave"
					label="预计离开时间"
					show-overflow-tooltip
					sortable="custom"
				></el-table-column>
				<el-table-column prop="deviceName" label="预约设备"></el-table-column>
				<el-table-column prop="source" label="预约途径">
					<template
						slot-scope="scope"
					>{{$common.getEnumItemName("visitor_singon_ways", scope.row.source)}}</template>
				</el-table-column>
				<el-table-column prop="approveState" label="审批状态">
					<template
						slot-scope="scope"
					>{{$common.getEnumItemName("reservation_record_s", scope.row.approveState)}}</template>
				</el-table-column>
				<el-table-column prop="visitState" label="来访状态">
					<template
						slot-scope="scope"
					>{{$common.getEnumItemName("visitor_record_s", scope.row.visitState)}}</template>
				</el-table-column>
