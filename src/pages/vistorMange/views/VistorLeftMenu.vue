      ...
      <el-col :span="24">
        <el-menu :default-active="defaultActive"
          ...
          <el-submenu index="1"
            ...
            <el-menu-item index="/VistorMange/VistorRecord"
                          :disabled="!$common.getAuthIsOwn('访客记录', 'isShow')">访客记录</el-menu-item>
            <el-menu-item index="/VistorMange/VistorList"
                          :disabled="!$common.getAuthIsOwn('访客列表', 'isShow')">访客列表</el-menu-item>
            <el-menu-item index="/VistorMange/VistorOpenRecord"
                          :disabled="!$common.getAuthIsOwn('访客开门记录', 'isShow')">访客开门记录</el-menu-item>
            <el-menu-item index="/VistorMange/AppointInviteRecord"
          ...
          <el-submenu index="2"
            ...
            <el-menu-item index="/vistorMange/VistorAccessConfig"
          ...
          <el-submenu index="3"
            ...
            <el-menu-item index="/VistorMange/VistorNotificationSet"
                          :disabled="!$common.getAuthIsOwn('访客预约邀请', 'isShow')">访客预约邀请</el-menu-item>
            <el-menu-item index="/VistorMange/VistorSignOff"
          ...
          <el-submenu index="4"
            ...
            <el-menu-item index="/VistorMange/VistorBlacklist"
                          :disabled="!$common.getAuthIsOwn('黑名单管理', 'isShow')">黑名单管理</el-menu-item>
            <el-menu-item index="/VistorMange/VistorBlacklistAlarm"
