	...
	>
		<div class="body">
				...
				<el-row type="flex" justify="flex-start" :gutter="20">
					...
					<el-col style="text-align:right;margin-right:-15px;" :span="5">
						<div v-if="showImg" class="imgBox">
							<img
								:src="vistorDetail.certificatePhotoUri? imageUrl+vistorDetail.certificatePhotoUri : require('@/assets/images/user.png')"
								alt
								srcset
							/>
						</div>
					...
					<el-col style="text-align:right;" :span="5">
						<div class="imgBox">
							<img
								:src="vistorDetail.snapPhotoUri? imageUrl+vistorDetail.snapPhotoUri : require('@/assets/images/user.png')"
								alt
								srcset
							/>
						</div>
			...
			<div class="body_box">
				<el-row type="flex" justify="flex-start" :gutter="20">
					...
					<el-col :span="19">
						<p
							v-for="(item,index) in vistorDetail.visitHistoryRedord"
							:key="index"
						...
						>
							...
							>{{$common.getEnumItemName("visitor_singon_ways", item.source) || ''}}</span>
		...
		<div slot="footer" class="dialogHeaderClass">
			<el-row type="flex" justify="flex-start">
				...
				<el-col :span="12">
					<el-button
						v-if="!vistorDetail.black"
						class="deleteBtn"
						@click="addToBlacklistAct"
						type="primary"
					>拉黑</el-button>
					<el-button v-else class="deleteBtn" @click="addToBlacklistAct" type="primary">解除拉黑</el-button>
