<template>
	<div class="dialogwrap">
		<el-dialog :title="title" :visible.sync="diglogvisible" @close="close" width="650px" center>
			<el-form ref="form" label-width="150px">
				<el-form-item label="任务名称：">
					<el-input v-model="kuname" class="myinput"></el-input>
				</el-form-item>
          ...
          <el-input v-model="kudescri"
				...
				<el-form-item label="导入方式：">
					<el-radio-group v-model="exprotway">
						<el-radio label="local">本地</el-radio>
						<el-radio label="ftp" disabled></el-radio>
						<!-- <el-radio label="ftp" disabled=""></el-radio> -->
					</el-radio-group>
				</el-form-item>
			...
			<span
				class="dialog-footer button-div"
