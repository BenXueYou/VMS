<template>
  <div class='tablelist'
        ...
        <div class="item"
          ...
          <div class="header1">
            ...
            <img v-else
                 ...
                 alt="">
            <span class='adadr'
                  :style="{'color':item.alarmed?'#FF5F5F':''}">
              <!-- 消防门人行通道（紧急告警） -->
              {{item.zhuapai}}
            </span>
            <span class='aaac'
          ...
          <div class='content'>
            <div class="aitem">
              <div class="aitemimg">
                <img :src="item.zhuapaipic?item.zhuapaipic:userheader"
                     @click='showbig(item.zhuapaipic)'
                     alt="">
              </div>
              <div class="aitemprogress">
                <el-progress class='progressCircle'
              ...
              <div class="aitemimg">
                <img :src="item.kulipic?item.kulipic:userheader"
                     @click='showbig(item.kulipic)'
                     alt="">
              </div>
              <div class="aitemp">
                <!-- <p>{{item.alarmtime.split(" ")[1]}}&nbsp;</p> -->
                ...
                <p>
                  ...
                  <i class='el-icon-warning'
                     :style="{'color':item.alarmed?'#FF5F5F':item.librarycolor}"></i>
                  <!-- <img v-if="item.librarycolor!='red'"
                       src="data:image/png;base64,"
                       alt="">
                  <img v-else
                       src="data:image/png;base64,"
                       alt=""> -->
                </p>
              </div>
            </div>
    ...
    <el-dialog class='aaaaasdasd'
               title="图片详情"
               :visible.sync="dialogVisible">
      <img style='max-width:100%;display:block;margin:0 auto;max-height:400px;'
           :src="dialogImageUrl"
           alt="">
    </el-dialog>
  </div>
