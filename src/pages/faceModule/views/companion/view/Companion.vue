				...
				<div class="input">
					<div class="line-one">
						...
						<div class="search-btn">
							<el-button @click="queryAct" type="primary" size="small" icon="el-icon-search">开始搜索</el-button>
							<el-button @click="resetParams" type="primary" size="small">重置</el-button>
						</div>
					</div>
					<div class="line-two">
						<span class="topTitleTxt">同行次数不小于：</span>
						<el-input v-model="travelTogetherFrequency" class="time-interal" type="number"></el-input>
						<span class="timeText">次</span>
						<span class="topTitleTxt left-space">共同出现的摄像头个数不小于：</span>
						<el-input v-model="travelTogetherChannel" class="time-interal" type="number"></el-input>
