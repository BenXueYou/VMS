  ...
  <div class="duibidialogwrap">
    <el-dialog :title="title"
      ...
      <div class="top">
        ...
        <div class="item">
          <div class="headerimg">
            <img :src="detail.kuurl"
                 @click="bigImage(detail.kuurl)"
                 alt />
          </div>
      ...
      <div class="switchBtn">
        <div class="imagebtn"
             @click="showindex=0"
             :class="{'active':showindex===0}">人脸图片</div>
        <div class="imagebtn"
             @click="showindex=1"
             :class="{'active':showindex===1}">全景图片</div>
      </div>
      ...
      <!-- 处理意见状态选择 -->
      <el-radio-group class="radioGrounp"
                      v-model="radio">
