<template style="background-color:#0C0F1E">
  <el-row ref="faceRecordHeight"
    ...
    <el-row class="topBox"
      ...
      <div :span="4"
           class="topBoxDiv topBoxCheckBox">
        <span class="topTitleTxt"
              style="margin-right:15px;">属性:</span>
      ...
      <div :span="4"
           class="topBoxDiv topBoxCheckBox topBoxQualityCheckBox">
        <span class="topTitleTxt"
              style="margin-right:15px;">图片质量:</span>
    ...
    <el-row ref="middleHeight"
            v-loading="mainScreenLoading"
            element-loading-background="rgba(0, 0, 0, 0.8)"
            class="reccordBoxClass">
      <div class="reccordCellClass"
        ...
        <el-popover :visible-arrow="false"
                    ...
                    :width="cellwidth"
                    trigger="hover">
          <el-row class="FRelPopoverRow"
                  justify="space-between">
            <el-col class="FRelPopoverCol"
            ...
            <el-col :class="OwnAuthDisabled?'cursorClass':'disabled'"
          ...
          <el-row slot="reference"
                  class="recordCellImgBox">
            <div class="imgBox">
              <img :src="$common.setPictureShow(o.faceCapturePhotoUrl,PicSourceType)"
                   class="recordCellImg" />
            </div>
            <el-col class="recordCellFooter">
              <div class="textClips recordCellFooterTxt"
                   @mouseover="mymouseover"
                   @mouseout="mymouseout"
                   @mousemove="mymousemove">{{o.captureDatetime?o.captureDatetime:'---- --:--:--'}}</div>
              <div class="textClips recordCellFooterTxt"
                   @mouseover="mymouseover"
                   @mouseout="mymouseout"
                   @mousemove="mymousemove">{{o.channelName?o.channelName:'未知设备通道未知设备通道未知设备通道'}}</div>
            </el-col>
          </el-row>
        </el-popover>
      </div>
    ...
    <!-- ======================================================= 人脸 弹 窗 ========================================================== -->
    <el-dialog class="dialogPhotoClass"
               :visible.sync="dialogVisible"
               :title="titleTxt">
      <div class="leftImgBox">
        <el-image :src="$common.setPictureShow(dialogPhotoImgUrl,PicSourceType)"
                  :preview-src-list="[$common.setPictureShow(dialogPhotoImgUrl,PicSourceType)]"></el-image>
      </div>
      <div class="rightImgBox">
        <el-image :src="$common.setPictureShow(dialogPanoramaImgUrl,PicSourceType)"
                  :preview-src-list="[$common.setPictureShow(dialogPanoramaImgUrl,PicSourceType)]"></el-image>
      </div>
    </el-dialog>
  </el-row>
</template>
