            ...
            <div :key="index"
              ...
              <div class="info-other">
                ...
                <div class="other-span desc"
                     :title="item.analysisResultDescribe">{{item.analysisResultDescribe}}</div>
                <div class="other-span desc">
                  {{item.staffName}}
                  <span :style="item.staffName ? 'margin-left: 5px;' : ''"
                        :title="item.faceLibraryName">{{item.faceLibraryName}}</span>
                </div>
        ...
        <div class="list-table"
          ...
          <el-table :data="moduleList"
            ...
            <el-table-column prop="status"
                             label="状态">
              <template slot-scope="scope">{{$common.getEnumItemName('model_analysis_s', scope.row.status)}}</template>
            </el-table-column>
