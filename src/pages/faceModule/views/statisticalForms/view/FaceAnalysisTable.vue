	...
	<div class="face-main">
		...
		<div class="main-container">
			<div class="face-select">
				...
				<el-select v-model="conditionVal" filterable collapse-tags placeholder="请选择" class="dev-select">
					<el-option
				...
				<el-input v-model="interalVal" class="dev-input" type="number"></el-input>
				<div class="time-param">次</div>
				<el-button :disabled="!ShowAuthDisabled" class="search-btn" @click="queryAct" size="small" type="primary">查询</el-button>
			</div>
			<div class="face-table">
				<el-scrollbar style="height: 92%;transition:0.2s">
					<el-table :data="tableData" border v-loading="isLoading" style="width: 100%">
						...
						<el-table-column prop="channelName" label="设备名称" width="280"></el-table-column>
						<el-table-column prop="frequency" label="频度" width="190"></el-table-column>

						<el-table-column label="人脸照片" width="190">
                     ...
                     width="30px"
								...
								<el-image
									...
									:preview-src-list="[$common.setPictureShow(scope.row.faceCapturePhotoUrl, 'facelog')]"
								></el-image>
							</template>
						</el-table-column>
						<el-table-column label="全景照片" width="190">
							<template slot-scope="scope">
                     ...
                     width="50px"
								...
								<el-image
									...
									:preview-src-list="[$common.setPictureShow(scope.row.panoramaCapturePhotoUrl, 'facelog')]"
								></el-image>
							</template>
						</el-table-column>
