<template>
  <div class="xydialog">
    <big-img v-if="showImgs"
             @clickit="viewImg"
             :imgSrc="imgSrc"></big-img>
    <el-row type="flex"
            justify="center"
            class="xydialogBodyClass"
            :gutter="5">
      <el-col :span="9">
        <p>抓拍图片</p>
        <el-row type="flex"
          ...
          <el-col :span="10">
            <!-- <img
						...
						/>-->
            <el-image class="xydialog-card-img"
                      :src="$common.setPictureShow(taskInfo.faceCapturePhotoUrl,PicSourceType)"
                      :preview-src-list="[$common.setPictureShow(taskInfo.faceCapturePhotoUrl,PicSourceType)]"></el-image>
          </el-col>
          <el-col :span="14">
      ...
      <el-col :span="2">
        <el-progress class="el-progress-class"
                     color="#ffffff"
                     :stroke-width="2"
                     :width="55"
                     type="circle"
                     :percentage="taskInfo.similarity?parseInt(taskInfo.similarity.toFixed(0)):0"></el-progress>
      </el-col>
      <el-col :span="13">
        <p>布控图片</p>
        <el-row type="flex"
          ...
          <el-col :span="7">
            ...
            <el-image class="xydialog-card-img"
                      ...
                      :preview-src-list="[$common.setPictureShow(staffInfo.facePhotoUrl)]"></el-image>
          </el-col>
          <el-col :span="17">
            <el-row type="flex"
              ...
              <el-col :span="10"
                ...
                <!-- 判断人员类别 -->
                <div v-if="staffInfo.category && staffInfo.category.indexOf('staff')>-1">
                  人员类别：{{$common.getEnumItemName('category',staffInfo.category)}}</div>
                <div v-else>人员类别：{{$common.getEnumItemName('staff_category',staffInfo.category)}}</div>
    ...
    <div slot="footer"
         class="dialog-footer">
      <div class="footerBox">
        <div v-for="(item,index) in shootPhotoList && shootPhotoList.length || 8"
             :key="index"
             class="cardBox">
          <el-row class="cardBoxHeader"
                  type="flex"
                  justify="center">
            <el-col class="facePhoto"
                    :span="9">
              <el-image v-if="shootPhotoList[index]&&shootPhotoList[index].faceCapturePhotoUrl"
