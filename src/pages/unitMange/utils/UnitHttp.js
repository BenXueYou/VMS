...
export var unitHttp = {
   ...
   */
  getAllUnits(holder) {
    let api = `${window.config.protocolHeader}${ip}${RestApi.api.unitMange.getAllUnits}`;
   ...
   */
  delUnits(holder) {
    let api = `${window.config.protocolHeader}${ip}${RestApi.api.unitMange.delUnits}`;
   ...
   */
  selPeople(holder) {
    let api = `${window.config.protocolHeader}${ip}${RestApi.api.unitMange.selPeople}`;
