<template>
  <el-dialog :title="title"
    ...
    <div class="body">
      <div class="body_box"
        ...
        <el-row type="flex"
          ...
          <el-col style="text-align:left;"
                  :span="6">
            <img class="img"
                 src="@/assets/images/vistorManage/alarm_icon.png"
                 alt
                 srcset />
            报警图片
          </el-col>
        ...
        <el-row type="flex"
          ...
          <el-col :span="12">
            ...
            <p>{{alarmDetail.address||''}}</p>
          </el-col>
          <el-col style="text-align:right;margin-right:-15px;"
                  :span="8">
            <div class="imgBox">
              <img :src="alarmDetail.extInfo&&alarmDetail.extInfo.snapPhotoUrl? imageUrl+ alarmDetail.extInfo.snapPhotoUrl : require('@/assets/images/user.png')"
                   alt
                   srcset />
            </div>
          </el-col>
      ...
      <div class="body_box"
        ...
        <el-row type="flex"
          ...
          <el-col style="text-align:left;"
                  :span="7">
            <img class="img"
                 src="@/assets/images/vistorManage/vistor_icon.png"
                 alt
                 srcset />
            黑名单访客信息
          </el-col>
        ...
        <el-row type="flex"
          ...
          <el-col style="text-align:left ;margin-right:-15px;"
                  :span="8">
            <div class="imgBox">
              <img :src="alarmDetail.extInfo&&alarmDetail.extInfo.certificatePhotoUri? imageUrl+ alarmDetail.extInfo.certificatePhotoUri : require('@/assets/images/user.png')"
                   alt
                   srcset />
            </div>
          </el-col>
      ...
      <div class="body_box"
           style="border-bottom:0;padding-bottom:10px;">
        <el-row type="flex"
                justify="flex-start"
                :gutter="20">
          <el-col style="text-align:left;"
                  :span="5">
            <img class="img"
                 src="@/assets/images/vistorManage/alarm_deteal.png"
                 alt
                 srcset />
            警情处理
          </el-col>
        ...
        <el-row type="flex"
          ...
          <el-input type="textarea"
                    :rows="2"
                    placeholder="处理结论"
                    v-model="alarmDetail.dealContent.content"></el-input>
        </el-row>
      </div>
    </div>
    <div slot="footer"
      ...
      <el-row type="flex"
        ...
        <el-col :span="12">
          <el-button :loading="isloading"
                     ...
                     @click="blacklistAlarmDetailAct"
                     type="primary">确定</el-button>
          <el-button @click="close"
                     type="primary">搁置</el-button>
        </el-col>
      </el-row>
    </div>
  </el-dialog>
