      ...
      <div class="body_box"
        ...
        <el-row type="flex"
          ...
          <el-col style="text-align:right;margin-right:-15px;"
            ...
            <div v-if="showImg"
                 class="imgBox">
              <img :src="vistorAIDetail.certificatePhotoUri? imageUrl+vistorAIDetail.certificatePhotoUri : require('@/assets/images/user.png')"
                   alt
                   srcset />
            </div>
          </el-col>
          <el-col style="text-align:right;"
                  :span="5">
            <div class="imgBox">
              <img :src="vistorAIDetail.snapPhotoUri? imageUrl+vistorAIDetail.snapPhotoUri : require('@/assets/images/user.png')"
                   alt
                   srcset />
            </div>
      ...
      <div class="body_box">
        <el-row type="flex"
          ...
          <el-col :span="19">
            ...
            <p>
              <span class="activeFontClass"
                    @click="transferVistorList()">{{vistorAIDetail.staffName || ''}}</span>
            </p>
    ...
    <div slot="footer"
      ...
      <el-row type="flex"
        ...
        <el-button class="deleteBtn"
                   ...
                   @click="forbidBtnAct"
                   :disabled="!OwnAuthDisabled"
                   type="primary">收回通行权限</el-button>
        <div v-if="!vistorAIDetail.visitState">
          <el-button v-if="vistorAIDetail.signOff"
                     @click="confirm"
                     :disabled="!OwnAuthDisabled"
...
export default {
  ...
  methods: {
    ...
    addToWhitelistAct() {
      ...
      if (rowData.credentialNo === "") rowData.credentialNo = null;
      if (rowData.credentialType === "") rowData.credentialType = null;
      if (
