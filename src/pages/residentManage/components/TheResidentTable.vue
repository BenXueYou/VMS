        ...
        <div class="overflowX">
          <div class="btn-group">
            ...
            <el-popover ref="popover1"
                        ...
                        width="300"
                        trigger="click">
              <search-option-view :ShowAuthDisabled='ShowAuthDisabled'
              ...
              <template slot-scope="scope">
                <div class="tableCertificateBtnClass">
                  <span :class="ShowAuthDisabled?'cursorClass':'disabled'"
                    ...
                    <img v-if="ShowAuthDisabled"
                         class="img"
                         src="@/assets/images/personMange/detail.png"
                         style="margin-right: 5.9px;" />一人一档
                  </span>
                  <span v-if="isOneProject"
              ...
              <div class="cellBox"
                ...
                <el-popover :visible-arrow="false"
                  ...
                  <el-row class="popoverBox"
                    ...
                    <el-col :class="ShowAuthDisabled?'cursorClass':'disabled'"
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      projectUuid() {
        return (
          this.checkedLeftTreeData.projectUuid ||
  ...
  methods: {
    resizeView() {
      ...
      console.log(this.tableSize);
      if (pageSize !== this.tableSize && !this.resizeFlag) {
