    ...
    <div class="GlobalAlarmDialog">
      <el-row type="flex"
        ...
        <div>
          ...
          <div class="leftColBg">
            <!-- <img
						...
						/>-->
            <el-image class="GlobalAlarmDialog-card-img"
                      :src="$common.setPictureShow(dialogParama.faceCapturePhotoUrl,PicSourceType)"
                      :preview-src-list="[$common.setPictureShow(dialogParama.faceCapturePhotoUrl,PicSourceType)]"></el-image>
          </div>
          <p>抓拍图片</p>
        </div>
        <el-progress class="el-progress-class"
                     ...
                     :width="55"
                     type="circle"
                     :percentage="dialogParama.faceSimilarity?parseInt(dialogParama.faceSimilarity.toFixed(0)):0"></el-progress>
        <div class="rightBox">
          <div class="leftColBg">
            <!-- <img
							class="GlobalAlarmDialog-card-img"
            ...
            <el-image class="GlobalAlarmDialog-card-img"
                      :src="$common.setPictureShow(dialogParama.facePhotoUrl)"
                      :preview-src-list="[$common.setPictureShow(dialogParama.facePhotoUrl)]"></el-image>
          </div>
          <p>布控图片</p>
        </div>
