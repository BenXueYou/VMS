...
//   let url = `${protocolHeader}${ip}${RestApi.api.peopleMange.getEquipmentList}`;
//   return axios({
//     method: "get",
//     url,
//     params
//   });
// }
export function getEquipmentList(pms) {
  let params = pms.dada;
  let api = `${protocolHeader}${ip}${RestApi.api.peopleMange.getEquipmentList(
    params.projectUuid
  )}`;
  let data = {};
  for (let k in params) {
...
export function getPowerList(parms) {
  let params = parms.dada;
  let url = `${protocolHeader}${ip}${RestApi.api.peopleMange.getPowerList(
    params.projectUuid
  )}`;
...
export function getPeopleList(parms) {
  ...
  let url = `${protocolHeader}${ip}${RestApi.api.peopleMange.residentList(
    parms.id
  )}`;
  return axios({
    method: "get",
...
export function getPeopleStatistics(parms) {
  ...
  console.log("parms1111===", parms.dada);
  console.log("parms2222===", parms.id);
  let url = `${protocolHeader}${ip}${RestApi.api.peopleMange.residentStatistics(
    parms.id
  )}`;
  return axios({
    method: "get",
