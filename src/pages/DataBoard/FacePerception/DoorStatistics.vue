    ...
    <div class="main-container">
      ...
      <div class="search">
        ...
        <el-radio-group
          ...
          class="sType"
        >
          <el-radio label="all" border>网格</el-radio>
          <el-radio label="one" border>小区</el-radio>
        </el-radio-group>
        <span v-if="formType == 'one'" style="margin-left:30px">小区：</span>
        <el-select
          v-model="activeStreet"
          placeholder="请选择小区"
      ...
      <div class="reslut">
        <div id="myChart" class="chart-all"></div>
        <div class="time-line">
