...
export function getActHouseChart(params) {
  let url = townUrl.getActHouseChart(params.projectUuid);
  delete params.projectUuid;
  return axios({
    method: "get",
    url,
...
export function getPeoAlarmListZxd(params) {
  let url = townUrl.getPeoAlarmListZxd(params.projectUuid);
  delete params.projectUuid;
  return axios({
    method: "get",
    url,
