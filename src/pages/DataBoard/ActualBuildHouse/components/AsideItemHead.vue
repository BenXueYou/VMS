<template>
  <div class="head_wrap">
    ...
    <div class="head_sort"
         v-if="options.isSort">
      <div class="sort_up sort_item"
           v-show="sort == 1"
           @click="handleSort">
        <img src="@/assets/images/downTown/up.png"
             alt
             srcset />
        <span>升序</span>
      </div>
      <div class="sort_down sort_item"
           v-show="sort == 0"
           @click="handleSort">
        <img src="@/assets/images/downTown/down.png"
             alt
             srcset />
        <span>降序</span>
      </div>
    ...
    <div class="head_switch"
         v-if="options.isDayOrWeek">
      <div :class="['switch_item', this.switch == 1 ? 'switch_active' : '']"
           @click="handleChangeDayWeek(1)">
        日
      </div>
      <div :class="['switch_item', this.switch == 2 ? 'switch_active' : '']"
    ...
    <div class="head_full_screen"
      ...
      <img src="@/assets/images/downTown/full-screen.png"
           alt />
    </div>
  </div>
</template>
