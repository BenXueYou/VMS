    ...
    <div class="loginLogMain">
      ...
      <el-table ref="setLogBoxTable"
        ...
        <el-table-column prop="clientIp"
                         label="配置IP"></el-table-column>
        <el-table-column prop="moduleName"
                         label="模块"
                         :show-overflow-tooltip="true"></el-table-column>
        <el-table-column label="类型">
          <template slot-scope="scope">{{$common.getEnumItemName("setLogEventEnum", scope.row.eventType)}}</template>
        </el-table-column>
        <el-table-column prop="detail"
                         label="详情"
                         :show-overflow-tooltip="true"></el-table-column>
        <el-table-column prop="eventTime"
                         label="配置时间"></el-table-column>
      </el-table>
      <!----------------------------------表格分页器---------------------------------->
      <div class="footer">
