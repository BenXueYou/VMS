function slot_createVideo()
{
    ...
    // create video
    var video = video_mgr.play(JSON.stringify(jSignal), JSON.stringify(jMedia), url, "rtsp", action, 1, canvas, w, h);
...
function slot_download()
{
    ...
    var video = video_mgr.play(JSON.stringify(jSignal), JSON.stringify(jMedia), url, "rtsp", "download", 4);
